...
function customMenu:Closed()
    ...
    TriggerServerEvent('space:lscustom::saveMods', saveOldVehicle.customVeh)
end

function extras:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function livery:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function doorsLeft:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function doorsRight:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function doorsMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function modTank:Closed()
    ToggleDoor(VehicleToCustom, 4)
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function roofAir:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function Antibrouillard:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function maskPhares:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function modEngineBay2:Closed()
    ToggleDoor(VehicleToCustom, 4)
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end


function modEngineBay:Closed()
    ToggleDoor(VehicleToCustom, 4)
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function modHydrolic:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function trunkMod:Closed()
    ToggleDoor(VehicleToCustom, 5)
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function modSpeaker:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function ShiftLever:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end
function steeringWheel:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function visualSeats:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function speakersdoor:Closed()
    ToggleDoor(VehicleToCustom, 0)
    ToggleDoor(VehicleToCustom, 1)  
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function jauges:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function figurines:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function dashbordDetails:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function carExterior:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function carSubwoofer:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function carRoof:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function carRetro:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function carFender:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function carHood:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function carGrille:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function carFrame:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function carExhaust:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function sideSkirt:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function Bumper:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function frontBumper:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function backBumper:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function exteriorSpoiler:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function exteriorMain:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function interiorMain:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function interiorColor:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function dashboardColor:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function bikeWheelsMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function frontWheelsBikeMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function backWheelsBikeMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function wheelsColorMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function tiresMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function customTiresWheel:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function customSmokeTiresWheel:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function windowTint:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function wheelsMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function typeWheelsMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function luxuryWheelsMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function lowriderWheelsMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function muscleWheelsMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function toutterrainWheelsMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function sportWheelsMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function tuningWheelsMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end


function turboMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function transmissionMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function suspensionMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function blindageMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function freinsMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function moteurMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function klaxonMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function eclairageMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function phareMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function neonMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function neonbaseMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function neonsColorsMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function principalColors:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function chromeMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function classicMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function matMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function metalMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function metauxMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function nacreMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function secondaryColors:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function secondChromeMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function sClassicMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function sMatMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function sMetalMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end

function sMetauxMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end


function colorsMenu:Closed()
    ESX.Game.SetVehicleProperties(VehicleToCustom, saveOldVehicle.customVeh)
end
